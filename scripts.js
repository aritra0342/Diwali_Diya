...
async function loadParticles() {
    // Load all particles functionality
    await loadFull(tsParticles);

    // Define particle options for the fireworks mask effect
    const options = {
        name: "Fireworks Mask",
    ...
    // Load particles into the "tsparticles" div
    tsParticles.load("tsparticles", options);
}

// Run the function to initialize particles
loadParticles();
